...
class Contact extends Component {
    ...
    handleInputChange(event) {
        ...
        // Value of the changed input
        //If checkbox input is checked, then the value is target.checked otherwise value is target.value
        const value = target.type === "checkbox" ? target.checked : target.value;
        //Name of the changed input field
        const name = target.name;

        //Set the value obtained above to the input name of that value
        this.setState({
            [name]: value,
        });
    }
    ...
    //Function to handle which form input fields has been modified
    ...
    //Validate the form each time it is rerendered
    validate(firstname, lastname, telnum, email) {
        ...
        //Check every characters in the string to see if there is one @
    ...
    render() {
        //Check for the errors every time a form is rendered
